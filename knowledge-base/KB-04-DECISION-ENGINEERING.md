...
| Final synthesis (≥200K tokens of dossier input) | **Code** (default) or **Cowork** (also 1M on Opus 4.7/4.8 + Fable 5 / Max+ — 2026-05-27 for 4.7, 2026-06-01 for 4.8, 2026-06-10 for Fable 5) | Code remains default for synthesis: filesystem reads (no upload friction), sub-agent dispatch for parallel synthesis, repo-aware tooling for downstream commit work. Cowork at 1M context can handle ≥200K input but synthesis still benefits from Code's repo affordances. Model note: Fable 5 (Mythos-class, the strongest synthesis model) restored 2026-07-01 but usage-credits-only at ≈2× Opus since 2026-07-07 — reserve it for adjudication-critical synthesis; **Opus 4.8 is the cost-rational default**; Sonnet 5 (native 1M, $2/$10 promotional through 2026-08-31) is the budget option for bulk synthesis. See CLAUDE-SURFACE-ROUTING §1a/§1b. |
