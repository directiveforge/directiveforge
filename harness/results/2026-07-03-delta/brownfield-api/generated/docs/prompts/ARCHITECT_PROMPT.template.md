...
> **Phase 4 architect prompt** that turns a locked [DECISIONS.md](../../DECISIONS.md) entry into actionable engineering steps. The 14 sections + hard ceilings below are load-bearing — see [KB-04 §5](<KIT_ROOT>/knowledge-base/KB-04-DECISION-ENGINEERING.md#5-pillar-4--the-14-section-architect-prompt) for why each one exists.
<!-- ../../DECISIONS.md: the project's ledger relative to this file, e.g. "../../DECISIONS.md" or "../../governance/DECISIONS.md". <KIT_ROOT>: absolute path to the AI Workflow Engineering Kit, e.g. "/Users/jane/Projects/AI" — relative ../../../ escapes any project that isn't the kit itself. -->
>
