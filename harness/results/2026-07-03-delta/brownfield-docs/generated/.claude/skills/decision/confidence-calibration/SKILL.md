...
> **Tier note (this project = Intermediate).** `bayesian-update` is NOT installed here (Advanced-only). Where this skill's sibling-skills line routes new evidence to `bayesian-update`: at this tier, handle the prior-update inline (state the old estimate, the new evidence, and the revised estimate with its reference class). Installed siblings you can route to: `reversibility-check`, `disconfirming-evidence-first`, `steelman`, `pre-mortem`.
...
1. `knowledge-base/KB-05-CONVERSATIONAL-DECISION-ENGINEERING.md` §3 (catalog), §7.1 (frame-reversal context), §10 (failure modes — false-precision row).
2. `research/2026-05-26-decision-techniques.md` §2 row 7 (canonical procedure + output column).
...
- KB-05: `knowledge-base/KB-05-CONVERSATIONAL-DECISION-ENGINEERING.md`
- Dossier: `research/2026-05-26-decision-techniques.md` §2 row 7
- Primary sources:
