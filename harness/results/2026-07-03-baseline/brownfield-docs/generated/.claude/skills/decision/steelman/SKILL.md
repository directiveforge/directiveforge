...
> **Trigger**: User asks for evaluation of their own position, idea, plan, or argument — "what do you think of X" / "argue against this" / "stress-test this position" / "convince me I'm wrong" / "what's the counter-case to my X". This is the primary anti-sycophancy skill for argument-shaped artifacts (as opposed to plan-shaped artifacts, which route to `pre-mortem`).
...
- KB-05: `knowledge-base/KB-05-CONVERSATIONAL-DECISION-ENGINEERING.md` §3 (catalog), §4 (anti-sycophancy-meta integration), §7.2 (Concession-Threshold Protocol verbatim), §10 (failure modes)
- Dossier: `research/2026-05-26-decision-techniques.md` §2 row 5, §4 Pattern 2 (Concession-Threshold Protocol full text)
- Primary sources:
